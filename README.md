<div align="center">
  <img src="docs/assets/readme-hero.png" alt="Swanipe Hero" width="100%">
  
  <p><em>Primary project powered by RPC Fast. 26x faster than free RPCs.</em></p>
  
  [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen.svg)](https://rpcfast.vercel.app)
  [![Pitch Video](https://img.shields.io/badge/Pitch-Video-red.svg)](https://youtube.com/your-video)
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-rpcfast)
</div>
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-rpcfast.git
   cd frontier-rpcfast
   ```
